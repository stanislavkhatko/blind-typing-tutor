 ...
 * Standard layout used in Spain and Latin America
 */
export const esEsLayout: KeyboardLayout = {
    id: 'es-es',
    name: 'Español',
    language: 'es',
    flag: '🇪🇸',
    ...
    keys: [
        // Row 1 - Number row
        { id: 'backtick', primary: 'º', shifted: 'ª', altGr: '\\', group: 1 },
        ...
        { id: 'leftSquareBracket', primary: '`', shifted: '^', altGr: '[', group: 8 },
        { id: 'rightSquareBracket', primary: '+', shifted: '*', altGr: ']', group: 8 },
        { id: 'backSlash', primary: 'ç', shifted: 'Ç', altGr: '}', group: 8 },
        ...
        { id: 'cologn', primary: 'ñ', shifted: 'Ñ', group: 8 },
        { id: 'quote', primary: '´', shifted: '¨', altGr: '{', group: 8 },
