 ...
 * Standard layout used in Germany, Austria, and Switzerland
 */
export const deDeLayout: KeyboardLayout = {
    id: 'de-de',
    name: 'Deutsch (QWERTZ)',
    language: 'de',
    flag: '🇩🇪',
    leftHandKeys: ['q', 'w', 'e', 'r', 't', 'a', 's', 'd', 'f', 'g', 'z', 'x', 'c', 'v', 'b', 'ü', 'ö', 'ä'],
    keys: [
        // Row 1 - Number row
        ...
        { id: 'underscore', primary: 'ß', shifted: '?', altGr: '\\', group: 8 },
        ...
        { id: 'z', primary: 'z', shifted: 'Z', group: 5 }, // Z and Y swapped in QWERTZ
        ...
        { id: 'leftSquareBracket', primary: 'ü', shifted: 'Ü', group: 8 },
        ...
        { id: 'cologn', primary: 'ö', shifted: 'Ö', group: 8 },
        { id: 'quote', primary: 'ä', shifted: 'Ä', group: 8 },
        { id: 'enter', primary: 'enter', width: 'enter' },

        // Row 4 - Bottom row
        { id: 'shift-l', primary: 'shift', width: 'shift' },
        { id: 'y', primary: 'y', shifted: 'Y', group: 1 }, // Y and Z swapped in QWERTZ
        ...
        { id: 'm', primary: 'm', shifted: 'M', altGr: 'µ', group: 5 },
