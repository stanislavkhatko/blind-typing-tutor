 ...
 * Standard layout used in Portugal and Brazil
 */
export const ptPtLayout: KeyboardLayout = {
    id: 'pt-pt',
    name: 'Português',
    language: 'pt',
    flag: '🇵🇹',
    ...
    keys: [
        ...
        { id: 'cologn', primary: 'ç', shifted: 'Ç', group: 8 },
        { id: 'quote', primary: 'º', shifted: 'ª', group: 8 },
