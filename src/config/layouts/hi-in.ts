...
/**
 * Hindi QWERTY keyboard layout (Devanagari input)
 * Standard layout used in India for Hindi input
 */
export const hiInLayout: KeyboardLayout = {
  id: 'hi-in',
  name: 'हिन्दी (Devanagari)',
  language: 'hi',
  flag: '🇮🇳',
