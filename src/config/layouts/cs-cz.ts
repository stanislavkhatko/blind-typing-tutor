 ...
 * Standard layout used in Czech Republic
 */
export const csCzLayout: KeyboardLayout = {
  id: 'cs-cz',
  name: 'Čeština',
  language: 'cs',
  flag: '🇨🇿',
  ...
  keys: [
    ...
    { id: '2', primary: 'ě', shifted: '2', group: 1 },
    { id: '3', primary: 'š', shifted: '3', group: 2 },
    { id: '4', primary: 'č', shifted: '4', group: 3 },
    { id: '5', primary: 'ř', shifted: '5', group: 4 },
    { id: '6', primary: 'ž', shifted: '6', group: 4 },
    { id: '7', primary: 'ý', shifted: '7', group: 5 },
    { id: '8', primary: 'á', shifted: '8', group: 5 },
    { id: '9', primary: 'í', shifted: '9', group: 6 },
    { id: '0', primary: 'é', shifted: '0', group: 7 },
    { id: 'underscore', primary: '=', shifted: '%', group: 8 },
    { id: 'equal', primary: '´', shifted: 'ˇ', group: 8 },
    ...
    { id: 'y', primary: 'z', shifted: 'Z', group: 5 },
    ...
    { id: 'leftSquareBracket', primary: 'ú', shifted: '/', group: 8 },
    ...
    { id: 'slash', primary: '-', shifted: '_', group: 8 },
