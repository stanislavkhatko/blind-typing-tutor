 ...
 * Standard layout used in Hungary
 */
export const huHuLayout: KeyboardLayout = {
  id: 'hu-hu',
  name: 'Magyar',
  language: 'hu',
  flag: '🇭🇺',
  ...
  keys: [
    // Row 1 - Number row
    { id: 'backtick', primary: '0', shifted: '§', group: 1 },
    ...
    { id: '8', primary: '8', shifted: '_', group: 5 },
    { id: '9', primary: '9', shifted: '-', group: 6 },
    { id: '0', primary: 'ö', shifted: 'Ö', group: 7 },
    { id: 'underscore', primary: 'ü', shifted: 'Ü', group: 8 },
    { id: 'equal', primary: 'ó', shifted: 'Ó', group: 8 },
    ...
    { id: 'leftSquareBracket', primary: 'ő', shifted: 'Ő', group: 8 },
    { id: 'rightSquareBracket', primary: 'ú', shifted: 'Ú', group: 8 },
    { id: 'backSlash', primary: 'ű', shifted: 'Ű', group: 8 },
    ...
    { id: 'cologn', primary: 'é', shifted: 'É', group: 8 },
    { id: 'quote', primary: 'á', shifted: 'Á', group: 8 },
