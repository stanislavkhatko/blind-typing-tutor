...
/**
 * Norwegian QWERTY keyboard layout
 * Standard layout used in Norway
 */
export const noNoLayout: KeyboardLayout = {
  id: 'no-no',
  name: 'Norsk',
  language: 'no',
  flag: '🇳🇴',
  ...
  keys: [
    ...
    { id: 'leftSquareBracket', primary: 'å', shifted: 'Å', group: 8 },
    ...
    { id: 'cologn', primary: 'ø', shifted: 'Ø', group: 8 },
    { id: 'quote', primary: 'æ', shifted: 'Æ', group: 8 },
