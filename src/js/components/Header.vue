...
export default {
  name: "Header",
  components: {HeaderThemeModeSwitcher, HeaderInterfaceLanguage},
}
</script>
    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <a href="/" class="flex items-center">
          <img src="/img/logo.png" class="mr-3 h-6 sm:h-9" alt="Typot logo" />
          <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">{{ $t('general.typot') }}</span>
        </a>
